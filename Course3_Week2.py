...
theta = np.array([0, math.pi/6, math.pi/4, math.pi/3, math.pi/2, 2*math.pi/3]).T
...
print('\n', MassMatrix)
Coriolis_Centripetal = mr.VelQuadraticForces(theta, theta_dot, Mlist, Glist, Slist)
...
Joint_Acceleration = mr.ForwardDynamics(theta, theta_dot, tau, g, Ftip, Mlist, Glist, Slist)
print('\n', Joint_Acceleration)
